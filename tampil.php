...
<center><h1>Data Kependudukan Kota Malang</h1></center>
    ...
    while($data = mysqli_fetch_array($sql)){
        ...
        echo"<td><a href='form_update.php?ID_Anggota=".$data['ID_Anggota']."'>Edit Data</a></td>";
        echo"<td><a href='delete.php?ID_Anggota=".$data['ID_Anggota']."'onclick='return confirm(\"Apakah anda yakin ingin menghapus data?\")'>Hapus Data</a></td>";
        echo "</tr>";
    }
    ?>
    </table>
